...
export default function BioView({ bio: bio }: { bio: any }) {
  ...
  return (
    <div className="container mx-auto grid-cols-1 grid md:grid-cols-3 gap-x-32">
      {/* Fixed Left Sidebar */}
      ...
      <div className="md:h-screen  overflow-y-scroll col-span-2 scroll-m-0 py-5 no-scrollbar ">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 flex justify-center items-center mb-10">
